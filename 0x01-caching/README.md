...
- [Mandatory Tasks](#mandatory)
    - [0. Basic dictionary](#0-basic-dictionary)
    - [1. FIFO caching](#1-fifo-caching)
    - [2. LIFO Caching](#2-lifo-caching)
    - [3. LRU Caching](#3-lru-caching)
    - [4. MRU Caching](#4-mru-caching)
- [Advanced Task](#advanced)
    - [5. LFU Caching](#5-lfu-caching)
...
- `def get(self, key):`
    - Must return the value in `self.cache_data` linked to key.
    - If `key` is `None` or if the `key` doesn’t exist in `self.cache_data`, return N`o`ne.
